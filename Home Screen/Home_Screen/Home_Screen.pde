//Global Variables
color circleRed = #FF0303, white=255, black=0, blue=#200EED, Green=#30EA24;
color yellow=#FFF300;
Boolean turnOnYellow=false, turnOnBlue=false, turnOnGreen=false; 
...
void setup() {
  ...
  buttonX[1] = width * 2/3 * 2/3;//Section 1, subsection 1
  buttonY[1] = height * 1/3 * 1/3; //Section 1, subsection 1
  buttonWidth[1] = width * 1/3 * 1/3;
  buttonHeight[1] = height * 1/3 * 1/3;
  //
  //Button to illustrate arithmetic
  buttonX[2] = width * 1/6; //Section 2, subsection 1: denominator is 3*2, numerator is counted
